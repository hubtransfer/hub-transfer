// ===================================================
// SISTEMA DE TRANSFERS EMPIRE LISBON HOTEL & HUB TRANSFER v4.0
...
const CONFIG = {
  ...
  SPREADSHEET_ID: '12uW6XqVZJBIieHFl02zfatcWjPhHnYpZjydBK-JgV_A',
  SHEET_NAME: 'Empire LISBON-HUB',
  ...
  NAMES: {
    ...
    HOTEL_NAME: 'Empire Lisbon Hotel',
    SISTEMA_NOME: 'Sistema Empire Lisbon Hotel e Hub Transfer'
  },
  ...
  SISTEMA: {
    VERSAO: '4.0-Empire-Lisbon-Hub-Transfer-Integrado',
...
const HEADERS = [
  ...
  'Valor Impire Lisbon Hotel (€)', // M - Comissão do hotel
...
const PRICING_HEADERS = [
  ...
  'Valor Impire Lisbon Hotel (€)', // K - Comissão hotel
...
const MESSAGES = {
  ...
  WHATSAPP_TEMPLATES: {
    NOVO_TRANSFER: {
      TITULO: '*🚐 NOVO TRANSFER LISBON-HUB*',
...
function calcularPrecoInteligente(origem, destino, pessoas, bagagens, tipoServico = 'Transfer') {
 ...
 try {
   ...
   const locaisConhecidos = {
     ...
     'lisbon': { tipo: 'hotel', distanciaBase: 0 },
    ...
    if (typeof criarEmailHtmlInterativo === 'function') {
      ...
      if (temCliente && temEmojis && naoTemPrezado) {
        ...
        const dadosParaEnvio = [
          ...
          '+351999000000', 'TEST123', 'Aeroporto de Lisboa', 'Impire Lisbon Hotel',
          '10:00', 25.00, 7.50, 15.50, 2.00, 'Dinheiro', 'Recepção', 'Solicitado',
